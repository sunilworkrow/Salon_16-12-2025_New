...
export async function POST(req: Request) {
    ...
    try {
        ...
        const staffLink = `http://localhost:3000/verify-user?token=${resetToken}&email=${email}`;
            ...
            body: JSON.stringify({
                ...
                htmlContent: `
                    <div style="font-family:Arial;font-size:16px;">
                        <h2>Welcome!</h2>
                        <p>You have been invited to join our system as Admin.</p>
                        <p>Please click the button below to complete your account setup:</p>
                        
                         <a href="${staffLink}" style="padding: 10px 15px; background-color: #007bff; color: white; text-decoration: none;">Verify</a>
                        <br><br>
                        <p>Thank you!</p>
                    </div>
                `,
